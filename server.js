...
http.createServer((req,res)=>{
 ...
 if(u==='/health'){res.writeHead(200,{'Content-Type':mime['.json']});return res.end(JSON.stringify({ok:true,version:'6.0.0'}))}
...
}).listen(PORT,()=>console.log(`DOCH20 V6 en http://localhost:${PORT}`));
